...
I spent yesterday over at [[https://rudimentarylathe.wiki][the wiki]] because I missed how it was so easy to post to and how it tied all of my thoughts together so nicely. But, who wants to write in a little HTML text area in a browser all day when I could be in Emacs using Org mode with Vim bindings. Plus, I have an RSS feed, better archives, and it /looks/ better, IMO. The dilemma remains.
